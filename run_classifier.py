...
data_path = '/Users/elmer/penglei/BERT_Ner/resource'
model_path = '/Users/elmer/penglei/BERT_Ner/model/chinese_L-12_H-768_A-12'
out_path = '/Users/elmer/penglei/BERT_Ner/model'
...
flags.DEFINE_string("vocab_file", os.path.join(model_path, 'vocab.txt'),
...
flags.DEFINE_string("middle_output", data_path, "Dir was used to store middle data!")
